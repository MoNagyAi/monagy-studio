...
(async function () {
  ...
  if (!document.getElementById("home-pricing-faq-styles")) {
    ...
    style.textContent = `
      ...
      .home-pricing-table th,.home-pricing-table td{padding:13px 16px;border-right:1px solid var(--line);border-bottom:1px solid var(--line);vertical-align:middle}.home-pricing-table th:last-child,.home-pricing-table td:last-child{border-right:0}.home-pricing-table tr:last-child td{border-bottom:0}
      ...
      .home-feature-en{display:block;font-weight:700}.home-feature-ar{display:block;margin-top:3px;color:var(--gold);font:500 .78rem Cairo,sans-serif}.home-cell-en{display:block}.home-cell-ar{display:block;margin-top:6px;color:#d2c9b9;font:500 .9rem/1.7 Cairo,sans-serif}
